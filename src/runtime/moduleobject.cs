...
namespace Python.Runtime {
    ...
    internal class CLRModule : ModuleObject
    {
        ...
        [ModuleFunctionAttribute()]
        [ForbidPythonThreadsAttribute()]
        public static IntPtr IntPtr_int(int size)
        {
            var obj = new IntPtr(size);
            return obj;
        }

        [ModuleFunctionAttribute()]
        [ForbidPythonThreadsAttribute()]
        public static IntPtr IntPtr_long(long size)
        {
            var obj = new IntPtr(size);
            return obj;
        }
        ...
        {
            Console.WriteLine("{0} is int", i);
        }

        [ModuleFunctionAttribute()]
        [ForbidPythonThreadsAttribute()]
        public static void Print_long(long i)
        {
            Console.WriteLine("{0} is long", i);
        }
